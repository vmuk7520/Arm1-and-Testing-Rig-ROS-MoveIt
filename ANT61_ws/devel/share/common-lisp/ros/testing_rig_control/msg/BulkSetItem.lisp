...
(cl:defmethod cl:initialize-instance :after ((m <BulkSetItem>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkSetItem)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-msg:<BulkSetItem> is deprecated: use testing_rig_control-msg:BulkSetItem instead.")))
...
(cl:defmethod item1-val ((m <BulkSetItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:item1-val is deprecated.  Use testing_rig_control-msg:item1 instead.")
  (item1 m))

(cl:ensure-generic-function 'item2-val :lambda-list '(m))
(cl:defmethod item2-val ((m <BulkSetItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:item2-val is deprecated.  Use testing_rig_control-msg:item2 instead.")
  (item2 m))

(cl:ensure-generic-function 'value1-val :lambda-list '(m))
(cl:defmethod value1-val ((m <BulkSetItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:value1-val is deprecated.  Use testing_rig_control-msg:value1 instead.")
  (value1 m))

(cl:ensure-generic-function 'value2-val :lambda-list '(m))
(cl:defmethod value2-val ((m <BulkSetItem>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:value2-val is deprecated.  Use testing_rig_control-msg:value2 instead.")
  (value2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkSetItem>)))
  ...
  "testing_rig_control/BulkSetItem")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkSetItem)))
  "Returns string type for a message object of type 'BulkSetItem"
  "testing_rig_control/BulkSetItem")
