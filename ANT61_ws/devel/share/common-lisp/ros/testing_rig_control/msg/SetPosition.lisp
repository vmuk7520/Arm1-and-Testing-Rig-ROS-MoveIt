...
(cl:defmethod cl:initialize-instance :after ((m <SetPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-msg:<SetPosition> is deprecated: use testing_rig_control-msg:SetPosition instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:id-val is deprecated.  Use testing_rig_control-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <SetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-msg:position-val is deprecated.  Use testing_rig_control-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPosition>)))
  ...
  "testing_rig_control/SetPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPosition)))
  "Returns string type for a message object of type 'SetPosition"
  "testing_rig_control/SetPosition")
