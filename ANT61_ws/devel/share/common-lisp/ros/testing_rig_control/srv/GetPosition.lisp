...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<GetPosition-request> is deprecated: use testing_rig_control-srv:GetPosition-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <GetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:id-val is deprecated.  Use testing_rig_control-srv:id instead.")
  (id m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-request>)))
  ...
  "testing_rig_control/GetPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-request)))
  "Returns string type for a service object of type 'GetPosition-request"
  "testing_rig_control/GetPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<GetPosition-response> is deprecated: use testing_rig_control-srv:GetPosition-response instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:position-val is deprecated.  Use testing_rig_control-srv:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-response>)))
  ...
  "testing_rig_control/GetPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-response)))
  "Returns string type for a service object of type 'GetPosition-response"
  "testing_rig_control/GetPositionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition)))
  ...
  "testing_rig_control/GetPosition")