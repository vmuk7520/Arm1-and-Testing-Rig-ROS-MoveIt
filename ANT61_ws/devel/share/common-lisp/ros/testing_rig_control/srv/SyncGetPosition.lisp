...
(cl:in-package testing_rig_control-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SyncGetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncGetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<SyncGetPosition-request> is deprecated: use testing_rig_control-srv:SyncGetPosition-request instead.")))

(cl:ensure-generic-function 'id0-val :lambda-list '(m))
(cl:defmethod id0-val ((m <SyncGetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:id0-val is deprecated.  Use testing_rig_control-srv:id0 instead.")
  (id0 m))

(cl:ensure-generic-function 'id1-val :lambda-list '(m))
(cl:defmethod id1-val ((m <SyncGetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:id1-val is deprecated.  Use testing_rig_control-srv:id1 instead.")
  (id1 m))

(cl:ensure-generic-function 'id2-val :lambda-list '(m))
(cl:defmethod id2-val ((m <SyncGetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:id2-val is deprecated.  Use testing_rig_control-srv:id2 instead.")
  (id2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SyncGetPosition-request>)))
  ...
  "testing_rig_control/SyncGetPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SyncGetPosition-request)))
  "Returns string type for a service object of type 'SyncGetPosition-request"
  "testing_rig_control/SyncGetPositionRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SyncGetPosition-request>)))
  ...
  "ee2edb71184f0d84eae62d21dcdef2b3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SyncGetPosition-request)))
  "Returns md5sum for a message object of type 'SyncGetPosition-request"
  "ee2edb71184f0d84eae62d21dcdef2b3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SyncGetPosition-request>)))
  ...
  (cl:format cl:nil "uint8 id0~%uint8 id1~%uint8 id2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SyncGetPosition-request)))
  "Returns full string definition for message of type 'SyncGetPosition-request"
  (cl:format cl:nil "uint8 id0~%uint8 id1~%uint8 id2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SyncGetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncGetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<SyncGetPosition-response> is deprecated: use testing_rig_control-srv:SyncGetPosition-response instead.")))

(cl:ensure-generic-function 'position0-val :lambda-list '(m))
(cl:defmethod position0-val ((m <SyncGetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:position0-val is deprecated.  Use testing_rig_control-srv:position0 instead.")
  (position0 m))

(cl:ensure-generic-function 'position1-val :lambda-list '(m))
(cl:defmethod position1-val ((m <SyncGetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:position1-val is deprecated.  Use testing_rig_control-srv:position1 instead.")
  (position1 m))

(cl:ensure-generic-function 'position2-val :lambda-list '(m))
(cl:defmethod position2-val ((m <SyncGetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:position2-val is deprecated.  Use testing_rig_control-srv:position2 instead.")
  (position2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SyncGetPosition-response>)))
  ...
  "testing_rig_control/SyncGetPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SyncGetPosition-response)))
  "Returns string type for a service object of type 'SyncGetPosition-response"
  "testing_rig_control/SyncGetPositionResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SyncGetPosition-response>)))
  ...
  (cl:format cl:nil "int32 position0~%int32 position1~%int32 position2~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SyncGetPosition-response)))
  "Returns full string definition for message of type 'SyncGetPosition-response"
  (cl:format cl:nil "int32 position0~%int32 position1~%int32 position2~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SyncGetPosition)))
  ...
  "testing_rig_control/SyncGetPosition")