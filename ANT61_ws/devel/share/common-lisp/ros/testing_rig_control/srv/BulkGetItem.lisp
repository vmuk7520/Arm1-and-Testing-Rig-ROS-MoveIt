...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<BulkGetItem-request> is deprecated: use testing_rig_control-srv:BulkGetItem-request instead.")))
...
(cl:defmethod item1-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:item1-val is deprecated.  Use testing_rig_control-srv:item1 instead.")
  (item1 m))

(cl:ensure-generic-function 'item2-val :lambda-list '(m))
(cl:defmethod item2-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:item2-val is deprecated.  Use testing_rig_control-srv:item2 instead.")
  (item2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-request>)))
  ...
  "testing_rig_control/BulkGetItemRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-request)))
  "Returns string type for a service object of type 'BulkGetItem-request"
  "testing_rig_control/BulkGetItemRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testing_rig_control-srv:<BulkGetItem-response> is deprecated: use testing_rig_control-srv:BulkGetItem-response instead.")))

(cl:ensure-generic-function 'value1-val :lambda-list '(m))
(cl:defmethod value1-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:value1-val is deprecated.  Use testing_rig_control-srv:value1 instead.")
  (value1 m))

(cl:ensure-generic-function 'value2-val :lambda-list '(m))
(cl:defmethod value2-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testing_rig_control-srv:value2-val is deprecated.  Use testing_rig_control-srv:value2 instead.")
  (value2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-response>)))
  ...
  "testing_rig_control/BulkGetItemResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-response)))
  "Returns string type for a service object of type 'BulkGetItem-response"
  "testing_rig_control/BulkGetItemResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem)))
  ...
  "testing_rig_control/BulkGetItem")