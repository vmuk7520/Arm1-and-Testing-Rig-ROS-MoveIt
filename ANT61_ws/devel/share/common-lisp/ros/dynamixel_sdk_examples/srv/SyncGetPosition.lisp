...
(cl:defmethod id0-val ((m <SyncGetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:id0-val is deprecated.  Use dynamixel_sdk_examples-srv:id0 instead.")
  (id0 m))
...
(cl:defmethod position0-val ((m <SyncGetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-srv:position0-val is deprecated.  Use dynamixel_sdk_examples-srv:position0 instead.")
  (position0 m))
